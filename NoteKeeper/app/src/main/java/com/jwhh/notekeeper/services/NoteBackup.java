...
public class NoteBackup {
    ...
    private static final String TAG = "BackupCourses";
    ...
    public static void doBackup(Context context, String backupCourseId) {
        ...
        Log.d(TAG, ">>>***   BACKUP START - Thread: " + Thread.currentThread().getId() + "   ***<<<");
        while (cursor.moveToNext()) {
            ...
            if (!noteTitle.equals("")) {
                Log.d(TAG, ">>>Backing Up Note<<< " + courseId + "|" + noteTitle + "|" + noteText + "\n");
